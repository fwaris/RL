...
let solSet5 = [
    ...
    // 0.46641
    //"j2",[|2.0; 126.0; 380.0; 0.0; 0.64; -0.99; -0.76; -0.68; -1.0; -0.09|]
    // 0.44549
    "j31",[|2.0; 193.0; 580.0; 0.0; 1.0; -0.5; -0.03; -0.72; -1.0; -0.1|]
    "j32",[|2.0; 193.0; 580.0; 0.0; 1.0; -0.5; -0.03; -0.72; -1.0; -0.1|]
    // 0.44215
    //"j4",[|1.0; 83.0; 250.0; 1.0; 0.11; 0.0; -1.0; -0.6; -0.96; -0.04|]
    // 0.43807
    //"j5",[|1.0; 106.0; 320.0; 0.0; 0.06; -0.84; 0.0; -0.92; -0.72; 0.0|]
    // 0.43733
    //"j6",[|1.0; 80.0; 240.0; 1.0; 0.24; -0.43; -0.15; -0.98; -1.0; 0.0|]
    // 0.43554 *
    "j71",[|2.0; 113.0; 340.0; 1.0; 0.54; -1.0; -0.43; -0.81; -0.7; 0.0|]
    "j72",[|2.0; 113.0; 340.0; 1.0; 0.54; -1.0; -0.43; -0.81; -0.7; 0.0|]
    // 0.42928
    //"j8",[|1.0; 80.0; 240.0; 0.33; 0.98; -0.46; -1.0; -1.0; -0.72; 0.0|]
    // 0.42863
    //"j9",[|1.0; 56.0; 170.0; 0.85; 0.0; -0.39; -0.95; -0.68; -0.26; -0.03|]
    // 0.39806
    //"j10",[|1.0; 96.0; 290.0; 0.0; 0.89; -0.52; -0.04; -1.0; -0.69; 0.0|]
]
